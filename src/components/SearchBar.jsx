                ...
                <div className="search-bar-container">
                    <div className="bg-white mt-10 flex px-6 py-3 rounded-full shadow-xl border border-gray-300 overflow-hidden">
                        <input
                            ...
                            className="w-full text-gray-900 outline-none pl-4 text-md"
                        />
                        <button
                            type="submit"
                            className="bg-blue-600 hover:bg-blue-800 hover:shadow-lg px-6 py-3 transition-all text-white font-semibold rounded-full "
                        >
                            Suchen
                        </button>
                    </div>
